...
describe('CaixaDaLanchonete', () => {
    ...
    //Testando combos + adicionais
    test.each([
        ['combo1 + queijo', 'dinheiro', 'Item extra não pode ser pedido sem o principal', ['combo1,1', 'queijo,1']],
        ['combo1 + chantily', 'dinheiro', 'Item extra não pode ser pedido sem o principal', ['combo1,1', 'chantily,1']],
        ['combo2 + queijo', 'dinheiro', 'Item extra não pode ser pedido sem o principal', ['combo2,1', 'queijo,1']],
        ['combo2 + chantily', 'dinheiro', 'Item extra não pode ser pedido sem o principal', ['combo2,1', 'chantily,1']],
    ])('compra %p em %p deve resultar em %p', (_, formaDePagamento, resultadoEsperado, itens) =>
        validaTeste(formaDePagamento, resultadoEsperado, itens)); 

    //Testando valores negativos
    test.each([
        ['quantidade negativa + pagamento errado', 'cheque', 'Quantidade inválida!', ['cafe,1', 'sanduiche,-12']],
        ['quantidade negativa + chantily sozinho', 'dinheiro', 'Quantidade inválida!', ['chantily,1', 'sanduiche,-12']],
        ['quantidade negativa + queijo sozinho', 'dinheiro', 'Quantidade inválida!', ['queijo,1', 'sanduiche,-12']],
        ['quantidade negativa + dados certos', 'dinheiro', 'Quantidade inválida!', ['cafe,1', 'sanduiche,-12']],
    ])('compra %p em %p deve resultar em %p', (_, formaDePagamento, resultadoEsperado, itens) =>
        validaTeste(formaDePagamento, resultadoEsperado, itens));           
});
